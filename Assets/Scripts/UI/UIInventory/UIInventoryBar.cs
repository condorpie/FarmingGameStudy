...
public class UIInventoryBar : MonoBehaviour
{
    ...
    private void ClearInventorySlots()
    {
        ...
        {
            //loop through inv slots and update with blank sprite
    ...
    private void InventoryUpdated(InventoryLocation inventoryLocation, List<InventoryItem> inventoryList)
    {
        if (inventoryLocation == InventoryLocation.player)
        {
            ...
            {
                //loop through inventory slots and update with corresponding items
                for (int i = 0; i < inventorySlot.Length; i++)
                {
                    if (i < inventoryList.Count)
                    {
                        ...
                        if (itemDetails != null)
                        {
                            //updates images and text in inventory slot
    ...
    private void Update()
    {
        // switch inventory bar to top of screen depending on player
