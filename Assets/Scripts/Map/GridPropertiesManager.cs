...
public class GridPropertiesManager : SingletonMonobehaviour<GridPropertiesManager>, ISaveable
{
    ...
    private void ConnectDugGround(GridPropertyDetails gridPropertyDetails)
    {
        ...
        // Set 4 tiles if surrounding tiles are dug
    ...
    private void ConnectWateredGround(GridPropertyDetails gridPropertyDetails)
    {
        ...
        // Set 4 tiles if surrounding tiles are watered
        GridPropertyDetails adjacentGridPropertyDetails;
    ...
    {
        // Get wether surrounding tiles are dug or not
    ...
    public bool IsGridSquareDug(int xGrid, int yGrid)
    {
    ...
    {
        // Get wether surrounding tiles are watered or not
    ...
    public bool IsGridSquareWatered(int xGrid, int yGrid)
    {
        GridPropertyDetails gridPropertyDetails = GetGridPropertyDetails(xGrid, yGrid);
    ...
    private void InitialiseGridProperties()
    {
        ...
        foreach (SO_GridProperties so_GridProperties in so_gridPropertiesArray)
        {
            ...
            //Populate grid property dictionary - Iterate through all the grid properties in the grid SO gridproperties list
    ...
    private void AfterSceneLoaded()
    {
        ...
        //Find Crop Parent for transform
        if (GameObject.FindGameObjectWithTag(Tags.CropsParentTransform) != null)
        {
            cropParentTransfrom = GameObject.FindGameObjectWithTag(Tags.CropsParentTransform).transform;
        }
        else
        {
    ...
    /// <summary>
    /// Returns the Crop object at grid lcation or null if no crop was found
    /// </summary>
    /// 
    public Crop GetCropObjectAtGridLocation(GridPropertyDetails gridPropertyDetails)
    {
        ...
        //Loop through colliders to get gameobject
        Crop crop = null;
    ...
    public void ISaveableRestoreScene(string sceneName)
    {
        if (GameObjectSave.sceneData.TryGetValue(sceneName, out SceneSave sceneSave))
        {
            ...
            {
                // grid propertydetails found for the current scene destroy existing ground decoration
    ...
    public void ISaveableStoreScene(string sceneName)
    {
        ...
        //Create a scenesave for the scene
        SceneSave sceneSave = new SceneSave();
    ...
    {
        //Construct a key from coordinate
        string key = "x" + gridX + "y" + gridY;
    ...
    private void AdvanceDay(int gameYear, Season gameSeason, int gameDay, string gameDayOfWeek, int gameHour, int gameMinute, int gameSecond)
    {
            ...
            if (GameObjectSave.sceneData.TryGetValue(sO_GridProperties.sceneName.ToString(), out SceneSave sceneSave))
            {
                if (sceneSave.gridPropertyDetailsDictionary != null)
                {
                    for (int i = sceneSave.gridPropertyDetailsDictionary.Count - 1; i >= 0; i--)
                    {
                        ...
                        #region update all grid properties to reflect advance in the day
        ...
        //Dispay grid propert details to reflect changed values
        DisplayGridPropertyDetails();
